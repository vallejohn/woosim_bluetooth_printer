...
public class WoosimBTPrintService {
    // Debugging
...
/*        Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
        ...
        WoosimBTPrintService.this.start();
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (WoosimBTPrintService.this) {
                mConnectThread = null;
            }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    //mHandler.obtainMessage(MainActi, bytes, -1, rcvData).sendToTarget();
                } catch (IOException e) {
